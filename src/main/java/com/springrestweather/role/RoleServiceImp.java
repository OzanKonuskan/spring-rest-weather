...
public class RoleServiceImp implements RoleService {
	...
	// "Set" can be used for preventing duplicate roles/privileges in the future
	// besides that already,
	// During auth processing, Spring is preventing for duplicates with
